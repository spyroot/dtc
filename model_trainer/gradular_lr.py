...
class GradualWarmupScheduler(_LRScheduler):
    ...
    Args:
        ...
        We apply heuristic if multiplier = 1.0, lr starts from 0 and ends up with the base_lr.
    ...
    def multiplier_is_one(self):
        return [base_lr * (float(self.last_epoch) / self.total_epoch) for base_lr in self.base_lrs]

    def multiplier_is_not_one(self):
    ...
    def get_lr(self):
        ...
        if self.multiplier == 1.0:
            return self.multiplier_is_one()
        else:
            return self.multiplier_is_not_one()
